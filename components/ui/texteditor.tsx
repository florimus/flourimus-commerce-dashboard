const TextEditor = ({ error, ...props }: any) => {
  return (
    <>
      <div
        className={`w-full border${error ? ' border-red-500' : ' border-gray-200'}  rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600`}
      >
